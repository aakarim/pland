...
func CreatedAt(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func Txt(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func CreatedAtEQ(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedAt), v))
	})
}
...
func CreatedAtNEQ(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func CreatedAtIn(vs ...time.Time) predicate.Day {
...
func CreatedAtNotIn(vs ...time.Time) predicate.Day {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedAtGT(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func CreatedAtGTE(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func CreatedAtLT(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func CreatedAtLTE(v time.Time) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtEQ(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTxt), v))
	})
}
...
func TxtNEQ(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtIn(vs ...string) predicate.Day {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TxtNotIn(vs ...string) predicate.Day {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TxtGT(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtGTE(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtLT(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtLTE(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtContains(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtHasPrefix(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtHasSuffix(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtEqualFold(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func TxtContainsFold(v string) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
...
func HasPlanWith(preds ...predicate.Plan) predicate.Day {
	return predicate.Day(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
