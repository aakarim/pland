...
func (uc *UserCreate) SetCharmID(u uuid.UUID) *UserCreate {
	uc.mutation.SetCharmID(u)
	return uc
}
...
func (uc *UserCreate) AddPlanIDs(ids ...int) *UserCreate {
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.CharmID(); !ok {
		return &ValidationError{Name: "charm_id", err: errors.New(`ent: missing required field "User.charm_id"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.CharmID(); ok {
