...
type User struct {
	...
	// CharmID holds the value of the "charm_id" field.
	CharmID uuid.UUID `json:"charm_id,omitempty"`
...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldBio:
	...
	for i := range columns {
		...
		case user.FieldCharmID:
			if value, ok := values[i].(*uuid.UUID); !ok {
				return fmt.Errorf("unexpected type %T for field charm_id", values[i])
			} else if value != nil {
				u.CharmID = *value
			}
		case user.FieldName:
...
func (u *User) QueryPlans() *PlanQuery {
	return (&UserClient{config: u.config}).QueryPlans(u)
}
...
func (u *User) String() string {
	...
	builder.WriteString("charm_id=")
	builder.WriteString(fmt.Sprintf("%v", u.CharmID))
	builder.WriteString(", ")
